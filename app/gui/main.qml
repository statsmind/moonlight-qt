...
ApplicationWindow {
    ...
    // Jameshu: getQrcode 和 registerDevice 之间有参数联动
    ...
    function doEarlyInit() {
        ...
        ComputerManager.errorMessageDetected.connect(onErrorMessageDetected);
    }

    function onErrorMessageDetected(message) {
    ...
    Component.onCompleted: {
        ...
        // Jameshu: 在UI组件完全初始化后再开始设备注册流程，以避免触发SDLGamepadKeyNavigation断言
    ...
    // Dialog for displaying generic error messages from the backend
    ErrorMessageDialog {
    ...
    // Jameshu: 设备注册流程 - 现在在Component.onCompleted中调用，确保UI已初始化
